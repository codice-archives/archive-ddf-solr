...
public class SolrCatalogProvider extends MaskableImpl implements CatalogProvider {
    ...
    static {
        try {
            ...
            LOGGER.info("Exception loading describable properties", e);
        }
    ...
    public CreateResponse create(CreateRequest request) throws IngestException {
        ...
        try {
            ...
            LOGGER.warn("Solr server exception ingesting metacards", e);
            throw new IngestException("Server could not ingest metacard(s).");
        } catch (SolrException e) {
            LOGGER.warn("Solr exception ingesting metacards", e);
            throw new IngestException("Server could not ingest metacard(s).");
        } catch (IOException e) {
            LOGGER.warn("IO exception ingesting metacards", e);
        }
    ...
    public UpdateResponse update(UpdateRequest updateRequest) throws IngestException {
        ...
        try {
            ...
            LOGGER.warn("Solr exception doing query", e);
        }
        ...
        try {
            ...
            LOGGER.warn("Solr exception processing add", e);
            throw new IngestException("Provider is not able to process the request.");
        } catch (IOException e) {
            LOGGER.warn("IO exception processing add", e);
            throw new IngestException("Provider is not able to process the request.");
        }
    ...
    public DeleteResponse delete(DeleteRequest deleteRequest) throws IngestException {
        ...
        for (SolrDocument doc : docs) {
            ...
            try {
                ...
                LOGGER.info("Creating exception adding to deleted metacards", e);
                throw new IngestException("Could not create metacard(s).");
            }
        ...
        try {
            ...
            LOGGER.error("Solr exception deleting request message", e);
            throw new IngestException(COULD_NOT_COMPLETE_DELETE_REQUEST_MESSAGE);
        } catch (IOException e) {
